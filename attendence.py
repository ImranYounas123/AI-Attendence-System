...
class Attendence:
    def __init__(self,root):
        ...
        #   2nd img
        img2 = Image.open(r"E:\Study\5th semester\SWE_214 (Artificial Intelligent)\Python_Projects\Pthton_project_Ai\img\std3.jpg")
        img2 = img2.resize((500,130),Image.ANTIALIAS)
        self.photoimg2 = ImageTk.PhotoImage(img2)
        f_lbl = Label(self.root,image=self.photoimg2)
        f_lbl.place(x=500,y=0,width=500,height=130)
        # 3rd image
        img3 = Image.open(r"E:\Study\5th semester\SWE_214 (Artificial Intelligent)\Python_Projects\Pthton_project_Ai\img\std4.jpg")
    ...
    #   bg img 
        ...
        ttl_lbl = Label(bg_img,text="Atendence System",font=("times new roman",35,"bold"),bg="white",fg="darkgreen")
